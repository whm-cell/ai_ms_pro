...
class HarnessSampleTemplateTest(unittest.TestCase):
    ...
    def test_all_collection_templates_validate_against_target_checkers(self) -> None:
        ...
        self.assertNotIn("pre-tool-use-preflight-sample/v1", report.schema_counts)
        self.assertEqual(
            {
                ...
                "upgrade-decision-review": 6,
            },
            report.capture_gate_counts,
        )
        self.assertEqual({"not-applicable": 6, "placeholder": 13}, report.template_review_state_counts)
        ...
        self.assertEqual(6, report.schema_counts["harness-upgrade-decision/v1"])
    ...
    def test_gap_filter_limits_template_audit(self) -> None:
        ...
        self.assertEqual("not-applicable", report.validations[0].template_review_state)
        self.assertEqual("upgrade-decision-review", report.validations[0].capture_gate)
        self.assertEqual((), report.validations[0].template_review_blockers)
