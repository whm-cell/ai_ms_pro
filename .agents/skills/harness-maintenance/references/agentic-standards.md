...
- Harness optimization decision defaults: `docs/ai/standards/harness-optimization-decision-defaults.md`; keeps the current STAGE-00 optimization path evidence-first, local-first, and no-claim while routing sandbox, CI agent, hosted eval, and MCP/A2A choices through comparison or task-shape gates.
