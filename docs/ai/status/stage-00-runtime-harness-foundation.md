...
- 2026-06-03 至 06-17 已完成 capability 聚合、bounded vnext、external decisions、optimization defaults 与多项 review-required standards；这些只改善选择、证据、运行指标和可见性，外部副作用与能力宣称仍由 activation gates 阻断。
