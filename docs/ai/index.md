...
当前判断：harness 可用；stage-00 转向 bounded 增量；context budget 是 strict gate；active validation 仍只认 WS-01 / WS-02；外部能力、标准、prototype 和 code-shape claim 均按结构化 evidence / boundary 处理。
...
- Standards / skills：[standards](/Volumes/usd/codes/go_projects/ai_ms_pro/docs/ai/standards)、[agent productization readiness](/Volumes/usd/codes/go_projects/ai_ms_pro/docs/ai/standards/agent-productization-readiness.md)、[evidence-based coding standards](/Volumes/usd/codes/go_projects/ai_ms_pro/docs/ai/standards/evidence-based-coding-standards.md)、[harness capability model](/Volumes/usd/codes/go_projects/ai_ms_pro/docs/ai/harness-capability-model.md)、[evals](/Volumes/usd/codes/go_projects/ai_ms_pro/docs/ai/evals/README.md)、[tool contracts](/Volumes/usd/codes/go_projects/ai_ms_pro/docs/ai/tool-contracts/README.md)、[skill samples](/Volumes/usd/codes/go_projects/ai_ms_pro/docs/ai/skill-usage-samples.md)；更多标准从 `standards/` 目录按需进入。
...
- 最新 changelog：[Agent Productization Readiness](./changelog/2026-06-12-agent-productization-readiness.md)
