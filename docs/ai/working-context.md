...
- 2026-06-16 已新增 Coding Agent / Browser Harness Selection、Bounded Loop Triage 与 Mock Data Boundary：前两者改变比较/排序口径，mock-data boundary 只做前端样例数据 review-required 检查；均不新增 runtime claim。
