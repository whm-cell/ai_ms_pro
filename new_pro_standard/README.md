...
4. Enable Git hooks with `git config core.hooksPath .githooks`.
5. Rewrite `AGENTS.md`, `docs/ai/working-context.md`, `docs/ai/plan.md`, and `.codex/harness.toml` for the new project.
6. Import the first real `REQDOC / REQ / WS`.
7. Start the first vertical slice implementation.
