...
class LocalTraceSummarySamplesTest(unittest.TestCase):
    ...
    def test_repository_samples_pass(self) -> None:
        ...
        self.assertEqual(0, report.real_report_count)
        self.assertEqual(0, report.accepted_real_report_count)
        self.assertEqual(0, report.accepted_real_task_class_count)
        self.assertEqual({}, report.accepted_real_task_classes)
